    ...
    <div class="grid md:grid-cols-4 gap-8">
      ...
      <div class="md:col-span-2">
        <div class="flex items-center gap-2 mb-4">
          ...
          <span class="text-xl font-serif font-semibold">StitchCraft</span>
        </div>
        <p class="text-sm text-muted-foreground max-w-sm">
          Transform your 3D ideas into beautiful crochet patterns. Perfect for amigurumi, home decor, and creative projects.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2 text-sm text-muted-foreground">
          ...
          <li><a href="/gallery" class="hover:text-foreground transition-colors">Gallery</a></li>
          <li><a href="/tutorials" class="hover:text-foreground transition-colors">Tutorials</a></li>
        </ul>
      </div>
